const servicedata = [
  ...
  },
  {
    ...
    description:
      "Including community engagement and employment skills training.",
    about:
      "We believe in the importance of community engagement and empowerment for individuals with disabilities. Our community participation programs focus on providing opportunities for social interaction, skill development, and employment training. We work closely with local organizations and businesses to create inclusive environments where everyone can contribute and thrive.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Professional development training for providers including support coordinators.",
    about:
      "Our professional development training programs are designed to enhance the skills and knowledge of disability service providers, including support coordinators and caregivers. We offer a range of workshops, seminars, and online courses covering topics such as person-centered care, communication techniques, behavior management, and cultural competence.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Short-term, respite and medium-term accommodation options in Perth.",
    about:
  ...
  },
  {
    ...
    description:
      "Specialized assistance for accessible travel, overcoming mobility challenges.",
    about:
  ...
  },
  {
    ...
    description:
      "Empowering individuals with disabilities through ongoing encouragement, ",
    about:
      "Our skill retention programs are designed to help individuals with disabilities maintain and improve their existing skills. Whether you're looking to enhance your communication abilities, fine-tune your motor skills, or develop new hobbies and interests, our team is here to support you. We offer personalized training programs tailored to your unique needs and goals.",
    highlights: [
  ...
  {
    id: 7,
    imgIcons: "fa-solid fa-users",
    title: "Group & Center based activities",
    description: "Engaging group activities in community centers.",
    "about": "Our group and center-based activities offer engaging opportunities for individuals with disabilities to participate in various social, recreational, and skill-building activities. Whether it's joining a social group, attending skill-building workshops, enjoying recreational outings, or exploring creative arts programs, our aim is to provide a supportive community environment where everyone feels included and valued.",
    highlights: [
  ...
  {
    id: 8,
    imgIcons: "fa-solid fa-home",
    title: "Daily task Shared Living ",
    description: "Shared living arrangements with daily task support.",
    about:
      "Our daily task shared living program offers individuals with disabilities the opportunity to live in a supportive community environment while receiving assistance with daily tasks. Whether you need help with household chores, meal preparation, or personal care, our caregivers are here to support you in achieving your goals and maintaining your independence.",
    highlights: [
